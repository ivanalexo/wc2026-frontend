...
function outcomeColor(pred: "H" | "D" | "A") {
  return pred === "H" ? FIFA.red : pred === "A" ? FIFA.royalBlue : "rgba(255,255,255,0.4)";
}
...
export default async function FixtureDetailPage({
  ...
  params: { id: string };
    ...
    console.log("Fetching fixture with ID:", id); // Debug log
  ...
  return (
    <Box sx={{ py: { xs: 4, md: 6 } }}>
      <Container maxWidth="md">
            ...
            <Box sx={{ display: "flex", gap: 1, mb: 3, flexWrap: "wrap" }}>
              {match.group && (
                <Chip
                  ...
                  size="small"
                  sx={{ backgroundColor: "rgba(204,255,0,0.1)", color: FIFA.lime, fontWeight: 700, fontSize: "0.7rem" }}
                />
              )}
              {match.stage && (
                <Chip
                  label={match.stage}
                  size="small"
                  sx={{ backgroundColor: "rgba(255,255,255,0.05)", color: "text.secondary", fontSize: "0.7rem" }}
                />
              )}
            </Box>
            ...
            <Grid container spacing={2} sx={{ mb: 3, alignItems: "center" }}>
              <Grid size={{ xs: 5 }} sx={{ textAlign: "center" }}>
                ...
                <Typography
                  variant="h4"
                  sx={{
                    color: match.prediction?.prediction === "H" ? FIFA.red : FIFA.white,
                    lineHeight: 1.2,
                    fontWeight: 900
                  }}
                >
              ...
              <Grid size={{ xs: 5 }} sx={{ textAlign: "center" }}>
                ...
                <Typography
                  variant="h4"
                  sx={{
                    color: match.prediction?.prediction === "A" ? FIFA.royalBlue : FIFA.white,
                    lineHeight: 1.2,
                    fontWeight: 900
                  }}
                >
                ...
                <Typography variant="caption" color="text.secondary">Visitante</Typography>
              </Grid>
            </Grid>
          ...
          >
            <CardContent sx={{ p: { xs: 2.5, md: 3 } }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2.5 }}>
                ...
                <Typography variant="subtitle2" sx={{ fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", fontSize: "0.75rem" }}>
        ...
        {/* ── PREDICCIÓN DE MARCADOR (Client Component) ───────────────── */}
        {!hasScore && (
          <MatchScorePredictor
